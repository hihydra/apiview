...
$.fn.extend({
	seleFn:function(){
		$(this).each(function(){
			...
			if(_seleMenu.height()>130){
				_seleMenu.css({'overflow-y':'auto','height':130,'width':_seleMenu.width()+16,'border-top':'1px solid #d5d5d5'});/*<!--  2014-6-10 添加了 'border-top':'1px solid #d5d5d5'  -->*/
			}
			if(_seleMenu.width()<w-1){
				_seleMenu.width(w-1);
			}
